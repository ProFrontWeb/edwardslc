    ...
    lt = (function () {
      ...
      return (
        ...
        (t._slide = function (t, e) {
          ...
          if (
            ((o = t === F ? ((n = z), (i = G), M) : ((n = X), (i = J), K)), l && g(l).hasClass(V))
          )
            this._isSliding = !1;
            ...
            if ((g(this._element).trigger(i), !i.isDefaultPrevented())) {
              ...
              (g(this._element).removeClass(pt).addClass(vt),
                ...
                this._triggerArray.length &&
                  g(this._triggerArray).removeClass(Et).attr("aria-expanded", !0),
      ...
      return (
        ...
        (c._clearMenus = function (t) {
          if (!t || (3 !== t.which && ("keyup" !== t.type || 9 === t.which)))
            for (
              var e = [].slice.call(document.querySelectorAll(xt)), n = 0, i = e.length;
              n < i;
              n++
            ) {
    ...
    Hn = (function () {
      ...
      return (
        ...
        (t._activate = function (t, e, n) {
          var i = this,
            o = (
              !e || ("UL" !== e.nodeName && "OL" !== e.nodeName) ? g(e).children(On) : g(e).find(kn)
            )[0],
        ...
        (i._jQueryInterface = function (n) {
          return this.each(function () {
            var t = g(this),
              e = t.data(Un);
            if (
              (e || ((e = new i(this, "object" == typeof n && n)), t.data(Un, e)),
              "string" == typeof n)
            ) {
              if ("undefined" == typeof e[n]) throw new TypeError('No method named "' + n + '"');
              e[n](this);
