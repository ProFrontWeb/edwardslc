...
(void 0 === jQuery.migrateMute && (jQuery.migrateMute = !0),
  (function (e) {
    ...
    ((e.fn.size = function () {
      return (
        r("jQuery.fn.size() is deprecated and removed; use the .length property"),
        this.length
      );
    }),
      ...
      return (
        e.each(t.match(m), function (t, a) {
          e.expr.match.bool.test(a) &&
            (r("jQuery.fn.removeAttr no longer sets boolean properties: " + a), n.prop(a, !1));
        }),
    ...
    e.data = function (t, n, a) {
      ...
      if (n && "object" == typeof n && 2 === arguments.length) {
        ...
        for (var s in n)
          s !== e.camelCase(s)
            ? (r("jQuery.data() always sets/gets camelCased names: " + s), (o[s] = n[s]))
            : (i[s] = n[s]);
      ...
      return a && a.nodeType
        ? ((n = (a.ownerDocument || t.document).documentElement),
          e.contains(n, a)
            ...
            : (r("jQuery.fn.offset() requires an element connected to a document"), o))
    ...
    e.param = function (t, n) {
      ...
      return (
        void 0 === n &&
          a &&
          (r("jQuery.param() no longer uses jQuery.ajaxSettings.traditional"), (n = a)),
        k.call(this, t, n)
      );
    };
    ...
    e.fn.andSelf = function () {
      return (
        r("jQuery.fn.andSelf() is deprecated and removed, use jQuery.fn.addBack()"),
                    ...
                    (e.each(q, function (o, i) {
                      ...
                      n[i[1]](function () {
                        ...
                        t && e.isFunction(t.promise)
                          ? t.promise().done(r.resolve).fail(r.reject).progress(r.notify)
                          : r[i[0] + "With"](this === a ? r.promise() : this, s ? [t] : arguments);
                      });
                    }),
                      (t = null));
                  })
